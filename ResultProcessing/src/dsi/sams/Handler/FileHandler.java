...
public class FileHandler {
    ...
    public static void createResultFile(){
        String writerPath ="/home/dsi/work/DSi Assignment/ResultProcessing/src/dsi/sams/util/outPutFiles/result.csv"; //this is the path where I store result file
    ...
    public static void createMarkSheetFile(){
        String writerPath ="/home/dsi/work/DSi Assignment/ResultProcessing/src/dsi/sams/util/outPutFiles/mark_sheet.csv"; //this is the path where I store Marks sheet file
        try (PrintWriter pw = new PrintWriter(writerPath)) {
